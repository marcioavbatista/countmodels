...
static constexpr std::array<const char*, 10> locations_array__ =
  ...
  " (in 'lm', line 8, column 2 to column 17)",
  " (in 'lm', line 9, column 2 to column 12)",
  " (in 'lm', line 10, column 2 to column 22)",
  " (in 'lm', line 14, column 2 to column 42)",
  " (in 'lm', line 3, column 2 to column 17)",
  " (in 'lm', line 4, column 9 to column 10)",
  " (in 'lm', line 4, column 2 to column 14)",
  " (in 'lm', line 5, column 9 to column 10)",
  " (in 'lm', line 5, column 2 to column 14)"};
...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      auto beta = in__.template read<local_scalar_t__>();
